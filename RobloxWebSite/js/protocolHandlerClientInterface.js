...
$(document).ready(function () {
    // NovetusClientInterface is set as the primary interface via gameLaunchEntry.js.
    // ProtocolHandlerClientInterface is kept for reference and studio flows only.
